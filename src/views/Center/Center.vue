            ...
            <div class="center-view">
                <div class="avatar">
                    <img  v-if='!user_info.headIcon'
                        ...
                        class="avator-icon"
                    />
                    <img v-if='user_info.headIcon' :src='user_info.headIcon'
                        class="avator-icon"
                    />
                    <div class="nick-name"  v-if="user_info.userId" >{{user_info.mobile}} <span @click='exit()'>退出登录</span></div>
                    <div class="nick-name"  v-if="!user_info.userId"  @click="login()">立即登录</div>
                </div>
                ...
                <div class="margin-set system-set">
                    <img
                        ...
                        alt=""
                    />
                    <a href="/setting" class="label">设置</a>
                    <img
                        src="data:image/png;base64,"
                        alt=""
                        class="arrow"
    ...
    methods: {
      ...
      async mounted() {
        ...
        if (_token) {
            ...
            this.user_info = ret.data.userinfo
        }
    },
}
</script>
